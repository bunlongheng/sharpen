  ...
  return (
    <section className="card">
      ...
      <div className="chart-grid">
        <div className="chart-box"><span className="chart-title">Bar</span><div className="chart"><Bar data={barLine} options={options} /></div></div>
        <div className="chart-box"><span className="chart-title">Line</span><div className="chart"><Line data={barLine} options={options} /></div></div>
        <div className="chart-box"><span className="chart-title">Pie</span><div className="chart"><Pie data={circular} options={options} /></div></div>
        <div className="chart-box"><span className="chart-title">Doughnut</span><div className="chart"><Doughnut data={circular} options={options} /></div></div>
