  ...
  return (
    <section className="card">
      ...
      <div className="row">
        ...
        {/* Functional update form - the correct way when the next value depends on the previous one */}
        <button className="ghost" onClick={() => setCount((c) => c + 1)}>+1 (functional)</button>
