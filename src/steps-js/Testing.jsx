  ...
  return (
    <section className="card">
      ...
      <details className="notes">
        ...
        <ul>
          <li>
            Query by role/text (<code>getByRole</code>, <code>getByText</code>) - it mirrors how
            users and screen readers find things.
          </li>
          <li>
            <code>getBy*</code> throws if missing, <code>queryBy*</code> returns null (assert
            absence), <code>findBy*</code> is async (awaits appearance).
          </li>
          <li>
            Prefer <code>userEvent</code> over <code>fireEvent</code> for realistic interactions.
          </li>
          <li>
